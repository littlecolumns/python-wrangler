  ...
  <div class="content">
    <template v-if="pyenv">
      ...
      <template v-if="!pyenvHasAThree">
        ...
        <pre><code>pyenv install 3.10.3
pyenv global 3.10.3</code></pre>
      </template>
      <template v-else>
        ...
        <template v-if="showInstr">
          <p>If you'd like to install a different default Python, you'd run the code below. Just replace <code>3.10.3</code> with the version you're interested in. <code>pyenv install --list</code> will show you all possible versions.</p>
          <pre><code>pyenv install 3.10.3
pyenv global 3.10.3</code></pre>
